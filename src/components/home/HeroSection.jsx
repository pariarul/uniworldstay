    ...
    <section className="relative min-h-[90vh] flex flex-col items-center justify-center pt-24 pb-12 overflow-hidden">
      ...
      <div className="w-full max-w-7xl mx-auto px-4 text-center">
        ...
        <motion.p
          ...
          className="text-base md:text-xl text-slate-500 max-w-2xl mx-auto mb-10 leading-relaxed"
        >
        ...
        <div className="block md:hidden mt-6">
          <button className="w-full py-3 rounded-xl bg-primary text-white font-semibold shadow-lg">
            Search Properties
          </button>
        </div>
        ...
        <motion.div
          ...
          className="mt-14 text-slate-400 text-sm font-medium flex flex-col md:flex-row items-center justify-center gap-6"
        >
          <div className="flex -space-x-2">
            {[1, 2, 3, 4].map((i) => (
              <div
                key={i}
                className="relative w-8 h-8 rounded-full border-2 border-white bg-slate-200 overflow-hidden"
              >
                <Image
          ...
          <p>
            Trusted by <span className="text-slate-900 font-bold">5000+</span> tenants across the world
          </p>
        </motion.div>
